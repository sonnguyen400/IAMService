...
public class UserProfileService {
    ...
    public UserProfileGetVm findByAccountEmail(String accountEmail) {
        ...
        UserProfile userProfile = userProfileRepository.findByAccount_id(account.getId()).orElseThrow(() -> new ResourceNotFoundException("User's profile with email " + accountEmail + " has yet to be set"));
